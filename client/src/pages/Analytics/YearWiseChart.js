...
const YearWiseChart = ({width3,handleWidth3,data}) => {
 ...
 console.log(data)
  ...
  const desiredWidth3 = numTickValues * 50; // Adjust the factor as needed
  useEffect(() => {
    handleWidth3(desiredWidth3);
  }, [handleWidth3, desiredWidth3]);
    return (
    <>
    <ResponsiveLine
        ...
        width={width3 > desiredWidth3 ? width3 : desiredWidth3}
        xScale={{ type: 'point' }}
        yScale={{
            type: 'linear',
            min: 'auto',
